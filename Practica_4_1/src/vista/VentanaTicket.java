...
public class VentanaTicket extends JFrame{
    ...
    public VentanaTicket(GestionDato gD){
        super("Registrar Ticket");
        this.gD=gD;
       ...
       public void iniciaComponentes(){
        ...
        this.etiList.add(new JLabel("Numero de Ticket"));
        this.etiList.add(new JLabel("Parqueadero"));
        this.etiList.add(new JLabel("Vehiculo"));
        ...
        this.encabezado[0]= "Numero de ticket";
        this.encabezado[1] = "Parqueadero";
        this.encabezado[2] = "Vehiculo";
        
        this.datos = this.cargaDatosTabla(this.gD.getTicketList().size(),3);
